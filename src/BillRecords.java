...
public class BillRecords {
    ...
    public void printBill(){
        ...
        System.out.println("House No :"+customer.getHouseNumber());
        System.out.println("Date :"+getBillingDate());
        System.out.println("Units consumed :"+customer.getUnitsConsumed());
        System.out.println("Total payable amount :"+customer.calculateBill()+"\n");
